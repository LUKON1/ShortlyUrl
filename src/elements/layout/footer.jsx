...
function Footer() {
  ...
  return (
    <footer className="transition-all duration-200 ease-out bg-rose-400 dark:bg-slate-800 w-full md:h-[22vh] h-[38vh] relative mt-20 flex flex-col items-center shadow-inner">
      {location.pathname === "/myurls" && <a className="text-2xl font-bold text-rose-700 dark:text-rose-400 hover:text-rose-900 dark:hover:text-rose-300 transition-colors absolute p-2 -top-16" href="#top">
            {t("myurls.top")}
      </a>}
